import { a as expiringMap, i as resolveJsFrom } from "./resolve-pWjAK-4f.mjs";
import { n as cacheForDirs, t as bigSign } from "./utils-D8dQkKEd.mjs";
...
async function getTailwindConfig(options) {
	...
	if (jsConfig) {
		if (!stylesheet) return pathToApiMap.remember(`${pkgDir}:${jsConfig}`, async () => {
			const { loadV3 } = await import("./v3-D-mr2VVh.mjs");
	...
	return pathToApiMap.remember(`${pkgDir}:${stylesheet}`, async () => {
		const { loadV4 } = await import("./v4-C-HWEQJm.mjs");
...
export { error as a, sortClasses as i, getTailwindConfig as n, warn as o, sortClassList as r, createSorter as t };
